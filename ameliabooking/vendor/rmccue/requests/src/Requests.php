<?php
/**
 * AmeliaVendor_Requests for PHP
 *
 * Inspired by AmeliaVendor_Requests for Python.
 *
...
use AmeliaVendor\WpOrg\Requests\Auth\Basic;
use AmeliaVendor\WpOrg\Requests\Capability;
use AmeliaVendor\WpOrg\Requests\Cookie\Jar;
use AmeliaVendor\WpOrg\Requests\Exception;
use AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument;
use AmeliaVendor\WpOrg\Requests\Hooks;
use AmeliaVendor\WpOrg\Requests\IdnaEncoder;
use AmeliaVendor\WpOrg\Requests\Iri;
use AmeliaVendor\WpOrg\Requests\Proxy\Http;
use AmeliaVendor\WpOrg\Requests\Response;
use AmeliaVendor\WpOrg\Requests\Transport\Curl;
use AmeliaVendor\WpOrg\Requests\Transport\Fsockopen;
use AmeliaVendor\WpOrg\Requests\Utility\InputValidator;
...
class Requests {
	 ...
	 * Option defaults.
	 *
	 * @see \AmeliaVendor\WpOrg\Requests\Requests::get_default_options()
	 * @see \AmeliaVendor\WpOrg\Requests\Requests::request() for values returned by this method
	 *
	 * @since 2.0.0
	 *
	 * @var array
	 ...
	 *
	 * @see \AmeliaVendor\WpOrg\Requests\Requests::get_certificate_path()
	 * @see \AmeliaVendor\WpOrg\Requests\Requests::set_certificate_path()
	 *
	 * @var string
	 */
	 ...
	 *
	 * @param array<string, bool> $capabilities Optional. Associative array of capabilities to test against, i.e. `['<capability>' => true]`.
	 * @return \AmeliaVendor\WpOrg\Requests\Transport
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception If no valid transport is found (`notransport`).
	 */
	...
	/**#@+
	 * @see \AmeliaVendor\WpOrg\Requests\Requests::request()
	 * @param string $url
	 * @param array $headers
	 * @param array $options
	 * @return \AmeliaVendor\WpOrg\Requests\Response
	 */
	/**
	 * Send a GET request
	 */
	 ...
	 *    (\AmeliaVendor\WpOrg\Requests\Auth|array|boolean, default: false)
	 * - `proxy`: Proxy details to use for proxy by-passing and authentication
	 *    (\AmeliaVendor\WpOrg\Requests\Proxy|array|string|boolean, default: false)
	 ...
	 *    (string|\AmeliaVendor\WpOrg\Requests\Transport, default: {@see \WpOrg\Requests\Requests::getTransport()})
	 * - `hooks`: Hooks handler.
	 *    (\AmeliaVendor\WpOrg\Requests\HookManager, default: new \AmeliaVendor\WpOrg\Requests\Hooks())
	 ...
	 * @return \AmeliaVendor\WpOrg\Requests\Response
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $url argument is not a string or Stringable.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $type argument is not a string.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $options argument is not an array.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception On invalid URLs (`nonhttp`)
	 */
	 ...
	 * - `type`: HTTP request type (use \AmeliaVendor\WpOrg\Requests\Requests constants). Same as the `$type`
	 *    parameter to {@see \WpOrg\Requests\Requests::request()}
	 *    (string, default: `\WpOrg\Requests\Requests::GET`)
	 * - `cookies`: Associative array of cookie name to value, or cookie jar.
	 *    (array|\AmeliaVendor\WpOrg\Requests\Cookie\Jar)
	 *
	 ...
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $requests argument is not an array or iterable object with array access.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $options argument is not an array.
	 */
	 ...
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $url argument is not a string, Stringable or boolean.
	 */
	 ...
	 * @return void
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception When the $url is not an http(s) URL.
	 */
	 ...
	 * @return \AmeliaVendor\WpOrg\Requests\Response
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception On missing head/body separator (`requests.no_crlf_separator`)
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception On missing head/body separator (`noversion`)
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception On missing head/body separator (`toomanyredirects`)
	 */
	 ...
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed argument is not iterable.
	 */
	 ...
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed argument is not a string.
	 */
