...
class IdnaEncoder {
	 ...
	 *
	 * @see \AmeliaVendor\WpOrg\Requests\IdnaEncoder::to_ascii()
	 *
	 * @since 2.0.0
	 *
	 * @var int
	 ...
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed argument is not a string or a stringable object.
	 */
	 ...
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception Provided string longer than 64 ASCII characters (`idna.provided_too_long`)
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception Prepared string longer than 64 ASCII characters (`idna.prepared_too_long`)
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception Provided string already begins with xn-- (`idna.provided_is_prefixed`)
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception Encoded string longer than 64 ASCII characters (`idna.encoded_too_long`)
	 */
	 ...
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception Invalid UTF-8 codepoint (`idna.invalidcodepoint`)
	 */
	 ...
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception On character outside of the domain (never happens with Punycode) (`idna.character_outside_domain`)
	 */
	 ...
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception On invalid digit (`idna.invalid_digit`)
	 */
