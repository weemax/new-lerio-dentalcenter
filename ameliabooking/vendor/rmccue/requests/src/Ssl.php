<?php
/**
 * SSL utilities for AmeliaVendor_Requests
 *
...
final class Ssl {
	 ...
	 * @return bool
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $host argument is not a string or a stringable object.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $cert argument is not an array or array accessible.
	 */
	 ...
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When either of the passed arguments is not a string or a stringable object.
	 */
