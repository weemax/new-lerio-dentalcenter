...
class Response {
	 ...
	 *
	 * @var \AmeliaVendor\WpOrg\Requests\Response\Headers Array-like object representing headers
	 */
	public $headers = [];
	 ...
	 *
	 * @var \AmeliaVendor\WpOrg\Requests\Cookie\Jar Array-like object representing a cookie jar
	 */
	public $cookies = [];
	 ...
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception If `$allow_redirects` is false, and code is 3xx (`response.no_redirects`)
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\Http On non-successful status code. Exception class corresponds to "Status" + code (e.g. {@see \WpOrg\Requests\Exception\Http\Status404})
	 */
	 ...
	 * @return array
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception If `$this->body` is not valid json.
	 */
