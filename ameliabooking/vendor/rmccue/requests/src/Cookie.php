...
use AmeliaVendor\WpOrg\Requests\Response\Headers;
use AmeliaVendor\WpOrg\Requests\Utility\CaseInsensitiveDictionary;
...
class Cookie {
	 ...
	 * `'httponly'`.
	 *
	 * @var \AmeliaVendor\WpOrg\Requests\Utility\CaseInsensitiveDictionary|array Array-like object
	 */
	public $attributes = [];
	 ...
	 * @param array|\AmeliaVendor\WpOrg\Requests\Utility\CaseInsensitiveDictionary $attributes Associative array of attribute data
	 ...
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $name argument is not a string.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $value argument is not a string.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $attributes argument is not an array or iterable object with array access.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $flags argument is not an array.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $reference_time argument is not an integer or null.
	 */
	 ...
	 *
	 * @param \AmeliaVendor\WpOrg\Requests\Iri $uri URI to check
	 ...
	 * @return \AmeliaVendor\WpOrg\Requests\Cookie Parsed cookie object
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $cookie_header argument is not a string.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $name argument is not a string.
	 */
	 ...
	 *
	 * @param \AmeliaVendor\WpOrg\Requests\Response\Headers $headers Headers to parse from
	 * @param \AmeliaVendor\WpOrg\Requests\Iri|null $origin URI for comparing cookie origins
	 * @param int|null $time Reference time for expiration calculation
	 * @return array
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $origin argument is not null or an instance of the Iri class.
	 */
