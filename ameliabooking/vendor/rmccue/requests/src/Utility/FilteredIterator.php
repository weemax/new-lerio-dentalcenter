...
namespace AmeliaVendor\WpOrg\Requests\Utility;
...
final class FilteredIterator extends ArrayIterator {
	 ...
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $data argument is not iterable.
	 */
