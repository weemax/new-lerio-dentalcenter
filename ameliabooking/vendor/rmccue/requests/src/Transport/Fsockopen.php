...
namespace AmeliaVendor\WpOrg\Requests\Transport;
...
use AmeliaVendor\WpOrg\Requests\Port;
use AmeliaVendor\WpOrg\Requests\Requests;
use AmeliaVendor\WpOrg\Requests\Ssl;
use AmeliaVendor\WpOrg\Requests\Transport;
...
final class Fsockopen implements Transport {
	 ...
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $headers argument is not an array.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $data parameter is not an array or string.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When the passed $options argument is not an array.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception       On failure to connect to socket (`fsockopenerror`)
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception       On socket timeout (`timeout`)
	 */
	 ...
	 * @return bool
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception On failure to connect via TLS (`fsockopen.ssl.connect_error`)
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception On not obtaining a match for the host (`fsockopen.ssl.no_match`)
	 */
