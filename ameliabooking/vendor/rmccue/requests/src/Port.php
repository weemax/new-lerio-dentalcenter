<?php
/**
 * Port utilities for AmeliaVendor_Requests
 *
...
final class Port {
	 ...
	 * @return int
	 *
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception\InvalidArgument When a non-string input has been passed.
	 * @throws \AmeliaVendor\WpOrg\Requests\Exception                 When a non-supported port is requested ('portnotsupported').
	 */
