 ...
 *
 *    $ssh = new \AmeliaVendor\phpseclib3\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = \AmeliaVendor\phpseclib3\Crypt\PublicKeyLoader::load('...', '(optional) password');
 *
 *    $ssh = new \AmeliaVendor\phpseclib3\Net\SSH2('www.domain.tld');
...
use AmeliaVendor\phpseclib3\Crypt\ChaCha20;
...
use AmeliaVendor\phpseclib3\Crypt\Common\SymmetricKey;
...
use AmeliaVendor\phpseclib3\Crypt\Rijndael;
use AmeliaVendor\phpseclib3\Crypt\RSA;
use AmeliaVendor\phpseclib3\Crypt\TripleDES; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use AmeliaVendor\phpseclib3\Crypt\Twofish;
use AmeliaVendor\phpseclib3\Exception\ConnectionClosedException;
use AmeliaVendor\phpseclib3\Exception\InsufficientSetupException;
use AmeliaVendor\phpseclib3\Exception\InvalidPacketLengthException;
use AmeliaVendor\phpseclib3\Exception\NoSupportedAlgorithmsException;
use AmeliaVendor\phpseclib3\Exception\TimeoutException;
use AmeliaVendor\phpseclib3\Exception\UnableToConnectException;
...
class SSH2
{
     ...
     *
     * @see \AmeliaVendor\phpseclib3\Net\SSH2::getLog()
     */
    const LOG_SIMPLE = 1;
    /**
     ...
     *
     * @see \AmeliaVendor\phpseclib3\Net\SSH2::read()
     */
    const READ_SIMPLE = 1;
    /**
