 ...
 *
 * $ourPrivate = \AmeliaVendor\phpseclib3\Crypt\DH::createKey();
...
use AmeliaVendor\phpseclib3\Crypt\DH\Parameters;
use AmeliaVendor\phpseclib3\Crypt\DH\PrivateKey;
use AmeliaVendor\phpseclib3\Crypt\DH\PublicKey;
...
abstract class DH extends AsymmetricKey
{
    ...
    public static function computeSecret($private, $public)
    {
        ...
        if ($private instanceof \AmeliaVendor\phpseclib3\Crypt\EC\PrivateKey) {
            switch (true) {
                case $public instanceof \AmeliaVendor\phpseclib3\Crypt\EC\PublicKey:
