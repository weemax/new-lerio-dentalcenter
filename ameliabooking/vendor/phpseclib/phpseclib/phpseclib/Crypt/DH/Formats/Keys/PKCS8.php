 ...
 */
namespace AmeliaVendor\phpseclib3\Crypt\DH\Formats\Keys;
...
abstract class PKCS8 extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $components = ASN1::asn1map($decoded[0], \AmeliaVendor\phpseclib3\File\ASN1\Maps\DHParameter::MAP);
    ...
    public static function savePrivateKey(BigInteger $prime, BigInteger $base, BigInteger $privateKey, BigInteger $publicKey, $password = '', array $options = [])
    {
        ...
        $params = ASN1::encodeDER($params, \AmeliaVendor\phpseclib3\File\ASN1\Maps\DHParameter::MAP);
