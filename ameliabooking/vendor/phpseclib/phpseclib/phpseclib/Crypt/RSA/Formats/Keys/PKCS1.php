...
abstract class PKCS1 extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $key = ASN1::asn1map($decoded[0], \AmeliaVendor\phpseclib3\File\ASN1\Maps\RSAPrivateKey::MAP);
        if (is_array($key)) {
        ...
        $key = ASN1::asn1map($decoded[0], \AmeliaVendor\phpseclib3\File\ASN1\Maps\RSAPublicKey::MAP);
        if (!is_array($key)) {
    ...
    public static function savePrivateKey(BigInteger $n, BigInteger $e, BigInteger $d, array $primes, array $exponents, array $coefficients, $password = '', array $options = [])
    {
        ...
        $key = ASN1::encodeDER($key, \AmeliaVendor\phpseclib3\File\ASN1\Maps\RSAPrivateKey::MAP);
    ...
    public static function savePublicKey(BigInteger $n, BigInteger $e)
    {
        ...
        $key = ASN1::encodeDER($key, \AmeliaVendor\phpseclib3\File\ASN1\Maps\RSAPublicKey::MAP);
