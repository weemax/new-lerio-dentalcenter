...
abstract class PSS extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if (isset($key[$type . 'KeyAlgorithm']['parameters'])) {
            ...
            $params = ASN1::asn1map($decoded[0], \AmeliaVendor\phpseclib3\File\ASN1\Maps\RSASSA_PSS_params::MAP);
        } else {
            $params = [];
        }
        if (isset($params['maskGenAlgorithm']['parameters'])) {
            ...
            $params['maskGenAlgorithm']['parameters'] = ASN1::asn1map($decoded[0], \AmeliaVendor\phpseclib3\File\ASN1\Maps\HashAlgorithm::MAP);
        } else {
    ...
    public static function savePSSParams(array $options)
    {
        ...
        */
        ...
        if (isset($options['MGFHash'])) {
            ...
            $temp = ASN1::encodeDER($temp, \AmeliaVendor\phpseclib3\File\ASN1\Maps\HashAlgorithm::MAP);
        ...
        return new ASN1\Element(ASN1::encodeDER($params, \AmeliaVendor\phpseclib3\File\ASN1\Maps\RSASSA_PSS_params::MAP));
    }
}