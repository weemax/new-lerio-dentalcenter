...
use AmeliaVendor\phpseclib3\Crypt\Common\Formats\Keys\PKCS8 as Progenitor;
...
abstract class PKCS8 extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $components = ASN1::asn1map($decoded[0], \AmeliaVendor\phpseclib3\File\ASN1\Maps\DSAParams::MAP);
        ...
        $components[$var] = ASN1::asn1map($decoded[0], \AmeliaVendor\phpseclib3\File\ASN1\Maps\DSAPublicKey::MAP);
    ...
    {
        $params = ['p' => $p, 'q' => $q, 'g' => $g];
        $params = ASN1::encodeDER($params, \AmeliaVendor\phpseclib3\File\ASN1\Maps\DSAParams::MAP);
        $params = new ASN1\Element($params);
        $key = ASN1::encodeDER($x, \AmeliaVendor\phpseclib3\File\ASN1\Maps\DSAPublicKey::MAP);
