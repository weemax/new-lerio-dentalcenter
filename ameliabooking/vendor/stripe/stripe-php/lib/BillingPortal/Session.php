...
namespace AmeliaVendor\Stripe\BillingPortal;
 ...
 * @property null|(object{after_completion: (object{hosted_confirmation: null|(object{custom_message: null|string}&\AmeliaVendor\Stripe\StripeObject), redirect: null|(object{return_url: string}&\AmeliaVendor\Stripe\StripeObject), type: string}&\AmeliaVendor\Stripe\StripeObject), subscription_cancel: null|(object{retention: null|(object{coupon_offer: null|(object{coupon: string}&\AmeliaVendor\Stripe\StripeObject), type: string}&\AmeliaVendor\Stripe\StripeObject), subscription: string}&\AmeliaVendor\Stripe\StripeObject), subscription_update: null|(object{subscription: string}&\AmeliaVendor\Stripe\StripeObject), subscription_update_confirm: null|(object{discounts: null|((object{coupon: null|string, promotion_code: null|string}&\AmeliaVendor\Stripe\StripeObject))[], items: ((object{id: null|string, price: null|string, quantity?: int}&\AmeliaVendor\Stripe\StripeObject))[], subscription: string}&\AmeliaVendor\Stripe\StripeObject), type: string}&\AmeliaVendor\Stripe\StripeObject) $flow Information about a specific flow for the customer to go through. See the <a href="https://stripe.com/docs/customer-management/portal-deep-links">docs</a> to learn more about using customer portal deep links and flows.
