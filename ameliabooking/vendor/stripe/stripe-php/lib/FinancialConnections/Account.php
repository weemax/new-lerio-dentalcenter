 ...
 * @property null|(object{account?: string|\AmeliaVendor\Stripe\Account, customer?: string|\AmeliaVendor\Stripe\Customer, type: string}&\AmeliaVendor\Stripe\StripeObject) $account_holder The account holder that this account belongs to.
 * @property null|(object{as_of: int, cash?: (object{available: null|\AmeliaVendor\Stripe\StripeObject}&\AmeliaVendor\Stripe\StripeObject), credit?: (object{used: null|\AmeliaVendor\Stripe\StripeObject}&\AmeliaVendor\Stripe\StripeObject), current: \AmeliaVendor\Stripe\StripeObject, type: string}&\AmeliaVendor\Stripe\StripeObject) $balance The most recent information about the account's balance.
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\AmeliaVendor\Stripe\StripeObject) $balance_refresh The state of the most recent attempt to refresh the account balance.
 ...
 * @property null|(object{last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\AmeliaVendor\Stripe\StripeObject) $ownership_refresh The state of the most recent attempt to refresh the account owners.
 ...
 * @property null|(object{id: string, last_attempted_at: int, next_refresh_available_at: null|int, status: string}&\AmeliaVendor\Stripe\StripeObject) $transaction_refresh The state of the most recent attempt to refresh the account transactions.
 */
class Account extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<Account> of ApiResources
     *
     ...
     * @param null|array|string $opts
     *
     * @return \AmeliaVendor\Stripe\Collection<AccountOwner> list of account owners
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
