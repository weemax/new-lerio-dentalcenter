...
namespace AmeliaVendor\Stripe\Checkout;
 ...
 * @property null|(object{enabled: bool}&\AmeliaVendor\Stripe\StripeObject) $adaptive_pricing Settings for price localization with <a href="https://docs.stripe.com/payments/checkout/adaptive-pricing">Adaptive Pricing</a>.
 * @property null|(object{recovery: null|(object{allow_promotion_codes: bool, enabled: bool, expires_at: null|int, url: null|string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $after_expiration When set, provides configuration for actions to take if this Checkout Session expires.
 ...
 * @property (object{enabled: bool, liability: null|(object{account?: string|\AmeliaVendor\Stripe\Account, type: string}&\AmeliaVendor\Stripe\StripeObject), provider: null|string, status: null|string}&\AmeliaVendor\Stripe\StripeObject) $automatic_tax
 ...
 * @property null|(object{shipping_details: null|(object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\AmeliaVendor\Stripe\StripeObject), name: string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $collected_information Information about the customer collected within the Checkout Session.
 * @property null|(object{promotions: null|string, terms_of_service: null|string}&\AmeliaVendor\Stripe\StripeObject) $consent Results of <code>consent_collection</code> for this session.
 * @property null|(object{payment_method_reuse_agreement: null|(object{position: string}&\AmeliaVendor\Stripe\StripeObject), promotions: null|string, terms_of_service: null|string}&\AmeliaVendor\Stripe\StripeObject) $consent_collection When set, provides configuration for the Checkout Session to gather active consent from customers.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|(object{amount_subtotal: int, amount_total: int, fx_rate: string, source_currency: string}&\AmeliaVendor\Stripe\StripeObject) $currency_conversion Currency conversion details for <a href="https://docs.stripe.com/payments/checkout/adaptive-pricing">Adaptive Pricing</a> sessions created before 2025-03-31.
 * @property ((object{dropdown?: (object{default_value: null|string, options: (object{label: string, value: string}&\AmeliaVendor\Stripe\StripeObject)[], value: null|string}&\AmeliaVendor\Stripe\StripeObject), key: string, label: (object{custom: null|string, type: string}&\AmeliaVendor\Stripe\StripeObject), numeric?: (object{default_value: null|string, maximum_length: null|int, minimum_length: null|int, value: null|string}&\AmeliaVendor\Stripe\StripeObject), optional: bool, text?: (object{default_value: null|string, maximum_length: null|int, minimum_length: null|int, value: null|string}&\AmeliaVendor\Stripe\StripeObject), type: string}&\AmeliaVendor\Stripe\StripeObject))[] $custom_fields Collect additional information from your customer using custom fields. Up to 3 fields are supported.
 * @property (object{after_submit: null|(object{message: string}&\AmeliaVendor\Stripe\StripeObject), shipping_address: null|(object{message: string}&\AmeliaVendor\Stripe\StripeObject), submit: null|(object{message: string}&\AmeliaVendor\Stripe\StripeObject), terms_of_service_acceptance: null|(object{message: string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $custom_text
 * @property null|string|\AmeliaVendor\Stripe\Customer $customer The ID of the customer for this Session. For Checkout Sessions in <code>subscription</code> mode or Checkout Sessions with <code>customer_creation</code> set as <code>always</code> in <code>payment</code> mode, Checkout will create a new customer object based on information provided during the payment flow unless an existing customer was provided when the Session was created.
 ...
 * @property null|(object{address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\AmeliaVendor\Stripe\StripeObject), email: null|string, name: null|string, phone: null|string, tax_exempt: null|string, tax_ids: null|((object{type: string, value: null|string}&\AmeliaVendor\Stripe\StripeObject))[]}&\AmeliaVendor\Stripe\StripeObject) $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Customer's address details are not present on Sessions in <code>setup</code> mode.
 ...
 * @property null|((object{coupon: null|string|\AmeliaVendor\Stripe\Coupon, promotion_code: null|string|\AmeliaVendor\Stripe\PromotionCode}&\AmeliaVendor\Stripe\StripeObject))[] $discounts List of coupons and promotion codes attached to the Checkout Session.
 * @property int $expires_at The timestamp at which the Checkout Session will expire.
 * @property null|string|\AmeliaVendor\Stripe\Invoice $invoice ID of the invoice created by the Checkout Session, if it exists.
 * @property null|(object{enabled: bool, invoice_data: (object{account_tax_ids: null|(string|\AmeliaVendor\Stripe\TaxId)[], custom_fields: null|(object{name: string, value: string}&\AmeliaVendor\Stripe\StripeObject)[], description: null|string, footer: null|string, issuer: null|(object{account?: string|\AmeliaVendor\Stripe\Account, type: string}&\AmeliaVendor\Stripe\StripeObject), metadata: null|\AmeliaVendor\Stripe\StripeObject, rendering_options: null|(object{amount_tax_display: null|string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $invoice_creation Details on the state of invoice creation for the Checkout Session.
 * @property null|\AmeliaVendor\Stripe\Collection<\AmeliaVendor\Stripe\LineItem> $line_items The line items purchased by the customer.
 ...
 * @property null|((object{adjustable_quantity: null|(object{enabled: bool, maximum: null|int, minimum: null|int}&\AmeliaVendor\Stripe\StripeObject), price: string, quantity: int}&\AmeliaVendor\Stripe\StripeObject))[] $optional_items The optional items presented to the customer at checkout.
 * @property null|string|\AmeliaVendor\Stripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode. You can't confirm or cancel the PaymentIntent for a Checkout Session. To cancel, <a href="https://stripe.com/docs/api/checkout/sessions/expire">expire the Checkout Session</a> instead.
 * @property null|string|\AmeliaVendor\Stripe\PaymentLink $payment_link The ID of the Payment Link that created this Session.
 ...
 * @property null|(object{id: string, parent: null|string}&\AmeliaVendor\Stripe\StripeObject) $payment_method_configuration_details Information about the payment method configuration used for this Checkout session if using dynamic payment methods.
 * @property null|(object{acss_debit?: (object{currency?: string, mandate_options?: (object{custom_mandate_url?: string, default_for?: string[], interval_description: null|string, payment_schedule: null|string, transaction_type: null|string}&\AmeliaVendor\Stripe\StripeObject), setup_future_usage?: string, target_date?: string, verification_method?: string}&\AmeliaVendor\Stripe\StripeObject), affirm?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), afterpay_clearpay?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), alipay?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), amazon_pay?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), au_becs_debit?: (object{setup_future_usage?: string, target_date?: string}&\AmeliaVendor\Stripe\StripeObject), bacs_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\AmeliaVendor\Stripe\StripeObject), setup_future_usage?: string, target_date?: string}&\AmeliaVendor\Stripe\StripeObject), bancontact?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), boleto?: (object{expires_after_days: int, setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), card?: (object{installments?: (object{enabled?: bool}&\AmeliaVendor\Stripe\StripeObject), request_extended_authorization?: string, request_incremental_authorization?: string, request_multicapture?: string, request_overcapture?: string, request_three_d_secure: string, restrictions?: (object{brands_blocked?: string[]}&\AmeliaVendor\Stripe\StripeObject), setup_future_usage?: string, statement_descriptor_suffix_kana?: string, statement_descriptor_suffix_kanji?: string}&\AmeliaVendor\Stripe\StripeObject), cashapp?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), customer_balance?: (object{bank_transfer?: (object{eu_bank_transfer?: (object{country: string}&\AmeliaVendor\Stripe\StripeObject), requested_address_types?: string[], type: null|string}&\AmeliaVendor\Stripe\StripeObject), funding_type: null|string, setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), eps?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), fpx?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), giropay?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), grabpay?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), ideal?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), kakao_pay?: (object{capture_method?: string, setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), klarna?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), konbini?: (object{expires_after_days: null|int, setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), kr_card?: (object{capture_method?: string, setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), link?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), mobilepay?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), multibanco?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), naver_pay?: (object{capture_method?: string}&\AmeliaVendor\Stripe\StripeObject), oxxo?: (object{expires_after_days: int, setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), p24?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), payco?: (object{capture_method?: string}&\AmeliaVendor\Stripe\StripeObject), paynow?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), paypal?: (object{capture_method?: string, preferred_locale: null|string, reference: null|string, setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), pix?: (object{expires_after_seconds: null|int}&\AmeliaVendor\Stripe\StripeObject), revolut_pay?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), samsung_pay?: (object{capture_method?: string}&\AmeliaVendor\Stripe\StripeObject), sepa_debit?: (object{mandate_options?: (object{reference_prefix?: string}&\AmeliaVendor\Stripe\StripeObject), setup_future_usage?: string, target_date?: string}&\AmeliaVendor\Stripe\StripeObject), sofort?: (object{setup_future_usage?: string}&\AmeliaVendor\Stripe\StripeObject), swish?: (object{reference: null|string}&\AmeliaVendor\Stripe\StripeObject), us_bank_account?: (object{financial_connections?: (object{filters?: (object{account_subcategories?: string[]}&\AmeliaVendor\Stripe\StripeObject), permissions?: string[], prefetch: null|string[], return_url?: string}&\AmeliaVendor\Stripe\StripeObject), setup_future_usage?: string, target_date?: string, verification_method?: string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property null|(object{update_shipping_details: null|string}&\AmeliaVendor\Stripe\StripeObject) $permissions <p>This property is used to set up permissions for various actions (e.g., update) on the CheckoutSession object.</p><p>For specific permissions, please refer to their dedicated subsections, such as <code>permissions.update_shipping_details</code>.</p>
 * @property null|(object{enabled: bool}&\AmeliaVendor\Stripe\StripeObject) $phone_number_collection
 * @property null|(object{presentment_amount: int, presentment_currency: string}&\AmeliaVendor\Stripe\StripeObject) $presentment_details
 ...
 * @property null|(object{allow_redisplay_filters: null|string[], payment_method_remove: null|string, payment_method_save: null|string}&\AmeliaVendor\Stripe\StripeObject) $saved_payment_method_options Controls saved payment method settings for the session. Only available in <code>payment</code> and <code>subscription</code> mode.
 * @property null|string|\AmeliaVendor\Stripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode. You can't confirm or cancel the SetupIntent for a Checkout Session. To cancel, <a href="https://stripe.com/docs/api/checkout/sessions/expire">expire the Checkout Session</a> instead.
 * @property null|(object{allowed_countries: string[]}&\AmeliaVendor\Stripe\StripeObject) $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 * @property null|(object{amount_subtotal: int, amount_tax: int, amount_total: int, shipping_rate: null|string|\AmeliaVendor\Stripe\ShippingRate, taxes?: ((object{amount: int, rate: \AmeliaVendor\Stripe\TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\AmeliaVendor\Stripe\StripeObject))[]}&\AmeliaVendor\Stripe\StripeObject) $shipping_cost The details of the customer cost of shipping, including the customer chosen ShippingRate.
 * @property ((object{shipping_amount: int, shipping_rate: string|\AmeliaVendor\Stripe\ShippingRate}&\AmeliaVendor\Stripe\StripeObject))[] $shipping_options The shipping rate options applied to this Session.
 ...
 * @property null|string|\AmeliaVendor\Stripe\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|(object{enabled: bool, required: string}&\AmeliaVendor\Stripe\StripeObject) $tax_id_collection
 * @property null|(object{amount_discount: int, amount_shipping: null|int, amount_tax: int, breakdown?: (object{discounts: (object{amount: int, discount: \AmeliaVendor\Stripe\Discount}&\AmeliaVendor\Stripe\StripeObject)[], taxes: ((object{amount: int, rate: \AmeliaVendor\Stripe\TaxRate, taxability_reason: null|string, taxable_amount: null|int}&\AmeliaVendor\Stripe\StripeObject))[]}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $total_details Tax and discount details for the computed total amount.
 ...
 * @property null|(object{link?: (object{display?: string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $wallet_options Wallet-specific configuration for this Checkout Session.
 */
class Session extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<Session> of ApiResources
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|array|string $opts
     *
     * @return \AmeliaVendor\Stripe\Collection<\AmeliaVendor\Stripe\LineItem> list of line items
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
