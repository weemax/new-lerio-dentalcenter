 ...
 * @property (object{balance?: string, billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\AmeliaVendor\Stripe\StripeObject), email: null|string, name: null|string}&\AmeliaVendor\Stripe\StripeObject), financial_account?: (object{id: string, network: string}&\AmeliaVendor\Stripe\StripeObject), issuing_card?: string, type: string, us_bank_account?: (object{bank_name: null|string, last4: null|string, routing_number: null|string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $initiating_payment_method_details
 ...
 * @property null|(object{deadline: null|int, restricted_reason: null|string}&\AmeliaVendor\Stripe\StripeObject) $reversal_details Details describing when a ReceivedCredit may be reversed.
 ...
 */
class ReceivedCredit extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<ReceivedCredit> of ApiResources
     *
