 ...
 * @property (object{cash: \AmeliaVendor\Stripe\StripeObject, inbound_pending: \AmeliaVendor\Stripe\StripeObject, outbound_pending: \AmeliaVendor\Stripe\StripeObject}&\AmeliaVendor\Stripe\StripeObject) $balance Balance information for the FinancialAccount
 ...
 * @property null|(object{inbound_flows: null|string, outbound_flows: null|string}&\AmeliaVendor\Stripe\StripeObject) $platform_restrictions The set of functionalities that the platform can restrict on the FinancialAccount.
 ...
 * @property (object{closed: null|(object{reasons: string[]}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $status_details
 ...
 */
class FinancialAccount extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<FinancialAccount> of ApiResources
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
