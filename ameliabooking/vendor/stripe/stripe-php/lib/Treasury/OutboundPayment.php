 ...
 * @property null|(object{billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\AmeliaVendor\Stripe\StripeObject), email: null|string, name: null|string}&\AmeliaVendor\Stripe\StripeObject), financial_account?: (object{id: string, network: string}&\AmeliaVendor\Stripe\StripeObject), type: string, us_bank_account?: (object{account_holder_type: null|string, account_type: null|string, bank_name: null|string, fingerprint: null|string, last4: null|string, mandate?: string|\AmeliaVendor\Stripe\Mandate, network: string, routing_number: null|string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|(object{ip_address: null|string, present: bool}&\AmeliaVendor\Stripe\StripeObject) $end_user_details Details about the end user.
 ...
 * @property null|(object{code: string, transaction: string|Transaction}&\AmeliaVendor\Stripe\StripeObject) $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 * @property (object{canceled_at: null|int, failed_at: null|int, posted_at: null|int, returned_at: null|int}&\AmeliaVendor\Stripe\StripeObject) $status_transitions
 * @property null|(object{ach?: (object{trace_id: string}&\AmeliaVendor\Stripe\StripeObject), type: string, us_domestic_wire?: (object{chips: null|string, imad: null|string, omad: null|string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $tracking_details Details about network-specific tracking information if available.
 * @property string|Transaction $transaction The Transaction associated with this object.
 */
class OutboundPayment extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<OutboundPayment> of ApiResources
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
