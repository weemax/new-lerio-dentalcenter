 ...
 * @property null|(object{code: string}&\AmeliaVendor\Stripe\StripeObject) $failure_details Details about this InboundTransfer's failure. Only set when status is <code>failed</code>.
 ...
 * @property (object{received_debit: null|string}&\AmeliaVendor\Stripe\StripeObject) $linked_flows
 ...
 * @property null|(object{billing_details: (object{address: (object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\AmeliaVendor\Stripe\StripeObject), email: null|string, name: null|string}&\AmeliaVendor\Stripe\StripeObject), type: string, us_bank_account?: (object{account_holder_type: null|string, account_type: null|string, bank_name: null|string, fingerprint: null|string, last4: null|string, mandate?: string|\AmeliaVendor\Stripe\Mandate, network: string, routing_number: null|string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $origin_payment_method_details Details about the PaymentMethod for an InboundTransfer.
 ...
 * @property (object{canceled_at?: null|int, failed_at: null|int, succeeded_at: null|int}&\AmeliaVendor\Stripe\StripeObject) $status_transitions
 * @property null|string|Transaction $transaction The Transaction associated with this object.
 */
class InboundTransfer extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<InboundTransfer> of ApiResources
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
