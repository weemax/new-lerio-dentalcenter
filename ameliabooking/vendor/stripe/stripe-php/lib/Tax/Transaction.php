 ...
 * @property null|\AmeliaVendor\Stripe\Collection<TransactionLineItem> $line_items The tax collected or refunded, by line item.
 ...
 * @property null|(object{original_transaction: null|string}&\AmeliaVendor\Stripe\StripeObject) $reversal If <code>type=reversal</code>, contains information about what was reversed.
...
class Transaction extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \AmeliaVendor\Stripe\Collection<TransactionLineItem> list of transaction line items
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
