 ...
 * @property (object{monetary: null|(object{currency: string, value: int}&\AmeliaVendor\Stripe\StripeObject), type: string}&\AmeliaVendor\Stripe\StripeObject) $amount
 * @property (object{scope: (object{price_type?: string, prices?: ((object{id: null|string}&\AmeliaVendor\Stripe\StripeObject))[]}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $applicability_config
 ...
 * @property string|\AmeliaVendor\Stripe\Customer $customer ID of the customer receiving the billing credits.
 ...
 * @property null|string|\AmeliaVendor\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this credit grant belongs to.
 ...
 */
class CreditGrant extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<CreditGrant> of ApiResources
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
