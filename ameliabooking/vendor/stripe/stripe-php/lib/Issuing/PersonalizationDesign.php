 ...
 * @property null|string|\AmeliaVendor\Stripe\File $card_logo The file for the card logo to use with physical bundles that support card logos. Must have a <code>purpose</code> value of <code>issuing_logo</code>.
 * @property null|(object{footer_body: null|string, footer_title: null|string, header_body: null|string, header_title: null|string}&\AmeliaVendor\Stripe\StripeObject) $carrier_text Hash containing carrier text, for use with physical bundles that support carrier text.
 ...
 * @property (object{is_default: bool, is_platform_default: null|bool}&\AmeliaVendor\Stripe\StripeObject) $preferences
 * @property (object{card_logo: null|string[], carrier_text: null|string[]}&\AmeliaVendor\Stripe\StripeObject) $rejection_reasons
 * @property string $status Whether this personalization design can be used to create cards.
 */
class PersonalizationDesign extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<PersonalizationDesign> of ApiResources
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
