 ...
 * @property null|string|\AmeliaVendor\Stripe\BalanceTransaction $balance_transaction ID of the <a href="https://stripe.com/docs/api/balance_transactions">balance transaction</a> associated with this transaction.
 ...
 * @property null|(object{authorization_code: null|string, processing_date: null|string, transaction_id: null|string}&\AmeliaVendor\Stripe\StripeObject) $network_data Details about the transaction, such as processing dates, set by the card network.
 * @property null|(object{fleet: null|(object{cardholder_prompt_data: null|(object{driver_id: null|string, odometer: null|int, unspecified_id: null|string, user_id: null|string, vehicle_number: null|string}&\AmeliaVendor\Stripe\StripeObject), purchase_type: null|string, reported_breakdown: null|(object{fuel: null|(object{gross_amount_decimal: null|string}&\AmeliaVendor\Stripe\StripeObject), non_fuel: null|(object{gross_amount_decimal: null|string}&\AmeliaVendor\Stripe\StripeObject), tax: null|(object{local_amount_decimal: null|string, national_amount_decimal: null|string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject), service_type: null|string}&\AmeliaVendor\Stripe\StripeObject), flight: null|(object{departure_at: null|int, passenger_name: null|string, refundable: null|bool, segments: null|((object{arrival_airport_code: null|string, carrier: null|string, departure_airport_code: null|string, flight_number: null|string, service_class: null|string, stopover_allowed: null|bool}&\AmeliaVendor\Stripe\StripeObject))[], travel_agency: null|string}&\AmeliaVendor\Stripe\StripeObject), fuel: null|(object{industry_product_code: null|string, quantity_decimal: null|string, type: string, unit: string, unit_cost_decimal: string}&\AmeliaVendor\Stripe\StripeObject), lodging: null|(object{check_in_at: null|int, nights: null|int}&\AmeliaVendor\Stripe\StripeObject), receipt: null|((object{description: null|string, quantity: null|float, total: null|int, unit_cost: null|int}&\AmeliaVendor\Stripe\StripeObject))[], reference: null|string}&\AmeliaVendor\Stripe\StripeObject) $purchase_details Additional purchase information that is optionally provided by the merchant.
 ...
 * @property null|(object{received_credit: null|string, received_debit: null|string}&\AmeliaVendor\Stripe\StripeObject) $treasury <a href="https://stripe.com/docs/api/treasury">Treasury</a> details related to this transaction if it was created on a [FinancialAccount](/docs/api/treasury/financial_accounts
