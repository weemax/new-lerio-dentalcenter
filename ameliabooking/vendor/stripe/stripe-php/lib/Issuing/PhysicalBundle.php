 ...
 * @property (object{card_logo: string, carrier_text: string, second_line: string}&\AmeliaVendor\Stripe\StripeObject) $features
 ...
 */
class PhysicalBundle extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<PhysicalBundle> of ApiResources
     *
