...
namespace AmeliaVendor\Stripe\EventData;

/**
 * @property string $developer_message_summary Extra field included in the event's <code>data</code> when fetched from /v2/events.
 * @property (object{error_count: int, error_types: (object{code: string, error_count: int, sample_errors: (object{error_message: string, request: (object{identifier: string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject)[]}&\AmeliaVendor\Stripe\StripeObject)[]}&\AmeliaVendor\Stripe\StripeObject) $reason This contains information about why meter error happens.
 ...
 */
class V1BillingMeterErrorReportTriggeredEventData extends \AmeliaVendor\Stripe\StripeObject {}
