 ...
 * @property null|(object{code: null|string, reason: null|string}&\AmeliaVendor\Stripe\StripeObject) $last_error If present, this property tells you the last error encountered when processing the verification.
 ...
 * @property null|(object{document?: (object{allowed_types?: string[], require_id_number?: bool, require_live_capture?: bool, require_matching_selfie?: bool}&\AmeliaVendor\Stripe\StripeObject), email?: (object{require_verification?: bool}&\AmeliaVendor\Stripe\StripeObject), id_number?: (object{}&\AmeliaVendor\Stripe\StripeObject), phone?: (object{require_verification?: bool}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $options A set of options for the session’s verification checks.
 * @property null|(object{email?: string, phone?: string}&\AmeliaVendor\Stripe\StripeObject) $provided_details Details provided about the user being verified. These details may be shown to the user.
 * @property null|(object{status: string}&\AmeliaVendor\Stripe\StripeObject) $redaction Redaction status of this VerificationSession. If the VerificationSession is not redacted, this field will be null.
 ...
 * @property null|(object{address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\AmeliaVendor\Stripe\StripeObject), dob?: null|(object{day: null|int, month: null|int, year: null|int}&\AmeliaVendor\Stripe\StripeObject), email: null|string, first_name: null|string, id_number?: null|string, id_number_type: null|string, last_name: null|string, phone: null|string}&\AmeliaVendor\Stripe\StripeObject) $verified_outputs The user’s verified data.
 */
class VerificationSession extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<VerificationSession> of ApiResources
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
