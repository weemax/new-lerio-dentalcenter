...
namespace AmeliaVendor\Stripe\Identity;
 ...
 * @property null|(object{address: null|(object{city: null|string, country: null|string, line1: null|string, line2: null|string, postal_code: null|string, state: null|string}&\AmeliaVendor\Stripe\StripeObject), dob?: null|(object{day: null|int, month: null|int, year: null|int}&\AmeliaVendor\Stripe\StripeObject), error: null|(object{code: null|string, reason: null|string}&\AmeliaVendor\Stripe\StripeObject), expiration_date?: null|(object{day: null|int, month: null|int, year: null|int}&\AmeliaVendor\Stripe\StripeObject), files: null|string[], first_name: null|string, issued_date: null|(object{day: null|int, month: null|int, year: null|int}&\AmeliaVendor\Stripe\StripeObject), issuing_country: null|string, last_name: null|string, number?: null|string, status: string, type: null|string}&\AmeliaVendor\Stripe\StripeObject) $document Result from a document check
 * @property null|(object{email: null|string, error: null|(object{code: null|string, reason: null|string}&\AmeliaVendor\Stripe\StripeObject), status: string}&\AmeliaVendor\Stripe\StripeObject) $email Result from a email check
 * @property null|(object{dob?: null|(object{day: null|int, month: null|int, year: null|int}&\AmeliaVendor\Stripe\StripeObject), error: null|(object{code: null|string, reason: null|string}&\AmeliaVendor\Stripe\StripeObject), first_name: null|string, id_number?: null|string, id_number_type: null|string, last_name: null|string, status: string}&\AmeliaVendor\Stripe\StripeObject) $id_number Result from an id_number check
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|(object{document?: (object{allowed_types?: string[], require_id_number?: bool, require_live_capture?: bool, require_matching_selfie?: bool}&\AmeliaVendor\Stripe\StripeObject), id_number?: (object{}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $options
 * @property null|(object{error: null|(object{code: null|string, reason: null|string}&\AmeliaVendor\Stripe\StripeObject), phone: null|string, status: string}&\AmeliaVendor\Stripe\StripeObject) $phone Result from a phone check
 * @property null|(object{document: null|string, error: null|(object{code: null|string, reason: null|string}&\AmeliaVendor\Stripe\StripeObject), selfie: null|string, status: string}&\AmeliaVendor\Stripe\StripeObject) $selfie Result from a selfie check
 ...
 */
class VerificationReport extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<VerificationReport> of ApiResources
     *
