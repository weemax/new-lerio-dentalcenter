 ...
 * @property null|(object{aws_account_id: string, aws_event_source_arn: string, aws_event_source_status: string}&\AmeliaVendor\Stripe\StripeObject) $amazon_eventbridge Amazon EventBridge configuration.
 ...
 * @property null|\AmeliaVendor\Stripe\StripeObject $metadata Metadata.
 ...
 * @property null|(object{disabled: null|(object{reason: string}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject) $status_details Additional information about event destination status.
 * @property string $type Event destination type.
 * @property int $updated Time at which the object was last updated.
 * @property null|(object{signing_secret: null|string, url: null|string}&\AmeliaVendor\Stripe\StripeObject) $webhook_endpoint Webhook endpoint configuration.
 */
class EventDestination extends \AmeliaVendor\Stripe\ApiResource
{
