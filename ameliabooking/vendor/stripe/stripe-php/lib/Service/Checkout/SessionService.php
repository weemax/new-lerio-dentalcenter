...
namespace AmeliaVendor\Stripe\Service\Checkout;
...
class SessionService extends \AmeliaVendor\Stripe\Service\AbstractService
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<\AmeliaVendor\Stripe\Checkout\Session>
     *
     ...
     * @param null|RequestOptionsArray|\AmeliaVendor\Stripe\Util\RequestOptions $opts
     *
     * @return \AmeliaVendor\Stripe\Checkout\Session
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
