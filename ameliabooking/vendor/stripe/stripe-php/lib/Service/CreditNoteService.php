...
class CreditNoteService extends AbstractService
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<\AmeliaVendor\Stripe\CreditNote>
     *
     ...
     * @param null|RequestOptionsArray|\AmeliaVendor\Stripe\Util\RequestOptions $opts
     *
     * @return \AmeliaVendor\Stripe\Collection<\AmeliaVendor\Stripe\CreditNoteLineItem>
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\AmeliaVendor\Stripe\Util\RequestOptions $opts
     *
     * @return \AmeliaVendor\Stripe\CreditNote
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
