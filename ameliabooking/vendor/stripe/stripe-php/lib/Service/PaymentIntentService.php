...
class PaymentIntentService extends AbstractService
{
     ...
     *
     * @return \AmeliaVendor\Stripe\Collection<\AmeliaVendor\Stripe\PaymentIntent>
     *
     ...
     * @param null|RequestOptionsArray|\AmeliaVendor\Stripe\Util\RequestOptions $opts
     *
     * @return \AmeliaVendor\Stripe\PaymentIntent
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
     ...
     * @param null|RequestOptionsArray|\AmeliaVendor\Stripe\Util\RequestOptions $opts
     *
     * @return \AmeliaVendor\Stripe\SearchResult<\AmeliaVendor\Stripe\PaymentIntent>
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
