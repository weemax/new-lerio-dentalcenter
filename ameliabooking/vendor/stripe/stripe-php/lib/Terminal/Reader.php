 ...
 * @property null|(object{failure_code: null|string, failure_message: null|string, process_payment_intent?: (object{payment_intent: string|\AmeliaVendor\Stripe\PaymentIntent, process_config?: (object{enable_customer_cancellation?: bool, skip_tipping?: bool, tipping?: (object{amount_eligible?: int}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject)}&\AmeliaVendor\Stripe\StripeObject), process_setup_intent?: (object{generated_card?: string, process_config?: (object{enable_customer_cancellation?: bool}&\AmeliaVendor\Stripe\StripeObject), setup_intent: string|\AmeliaVendor\Stripe\SetupIntent}&\AmeliaVendor\Stripe\StripeObject), refund_payment?: (object{amount?: int, charge?: string|\AmeliaVendor\Stripe\Charge, metadata?: \AmeliaVendor\Stripe\StripeObject, payment_intent?: string|\AmeliaVendor\Stripe\PaymentIntent, reason?: string, refund?: string|\AmeliaVendor\Stripe\Refund, refund_application_fee?: bool, refund_payment_config?: (object{enable_customer_cancellation?: bool}&\AmeliaVendor\Stripe\StripeObject), reverse_transfer?: bool}&\AmeliaVendor\Stripe\StripeObject), set_reader_display?: (object{cart: null|(object{currency: string, line_items: (object{amount: int, description: string, quantity: int}&\AmeliaVendor\Stripe\StripeObject)[], tax: null|int, total: int}&\AmeliaVendor\Stripe\StripeObject), type: string}&\AmeliaVendor\Stripe\StripeObject), status: string, type: string}&\AmeliaVendor\Stripe\StripeObject) $action The most recent action performed by the reader.
 ...
 */
class Reader extends \AmeliaVendor\Stripe\ApiResource
{
     ...
     * @param null|array|string $opts
     *
     * @return \AmeliaVendor\Stripe\Collection<Reader> of ApiResources
     *
     * @throws \AmeliaVendor\Stripe\Exception\ApiErrorException if the request fails
     */
