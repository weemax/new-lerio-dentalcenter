...
use AmeliaVendor\Google\Auth\Credentials\ExternalAccountCredentials;
use AmeliaVendor\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use AmeliaVendor\Google\Auth\Credentials\InsecureCredentials;
    ...
    UpdateMetadataInterface
{
     ...
     * @return \AmeliaVendor\GuzzleHttp\Client
     */
    public static function makeHttpClient(
        ...
        $stack = \AmeliaVendor\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);

        return new \AmeliaVendor\GuzzleHttp\Client([
            'handler' => $stack,
            'auth' => 'google_auth',
        ] + $httpClientOptions);
    }
