...
class OAuth2 implements FetchAuthTokenInterface
{
     ...
     * @throws \AmeliaVendor\Firebase\JWT\SignatureInvalidException If the signature is invalid.
     * @throws \AmeliaVendor\Firebase\JWT\BeforeValidException If the token is not yet valid.
     * @throws \AmeliaVendor\Firebase\JWT\ExpiredException If the token has expired.
     * @return null|object
     */
