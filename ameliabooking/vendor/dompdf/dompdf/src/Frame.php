...
use AmeliaVendor\Dompdf\Frame\FrameListIterator;
/**
...
class Frame
{
     ...
     */
    public function set_decorator(\AmeliaVendor\Dompdf\FrameDecorator\AbstractFrameDecorator $decorator)
    {
    ...
    public function __toString()
    {
        ...
        if ($this->_decorator instanceof \AmeliaVendor\Dompdf\FrameDecorator\Block) {
            $str .= "Lines:<pre>";
            foreach ($this->_decorator->get_line_boxes() as $line) {
                foreach ($line->get_frames() as $frame) {
                    if ($frame instanceof \AmeliaVendor\Dompdf\FrameDecorator\Text) {
                        $str .= "\ntext: ";
