...
class CPDF implements Canvas
{
    ...
    public function __construct($paper = "letter", string $orientation = "portrait", ?Dompdf $dompdf = null)
    {
        ...
        $this->_pdf = new \AmeliaVendor\Dompdf\Cpdf($size, true, $this->_dompdf->getOptions()->getFontCache(), $this->_dompdf->getOptions()->getTempDir());
     ...
     *
     * @return \AmeliaVendor\Dompdf\Cpdf
     */
    ...
    public function select($x, $y, $w, $h, $font, $size, $color = [0, 0, 0], $opts = [])
    {
        ...
        $ft = \AmeliaVendor\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE;
        $ff = \AmeliaVendor\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE_COMBO;
    ...
    public function textarea($x, $y, $w, $h, $font, $size, $color = [0, 0, 0])
    {
        ...
        $ft = \AmeliaVendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
        $ff = \AmeliaVendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_MULTILINE;
    ...
    public function input($x, $y, $w, $h, $type, $font, $size, $color = [0, 0, 0])
    {
        ...
        switch ($type) {
            ...
            case 'password':
                $ft = \AmeliaVendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
                $ff = \AmeliaVendor\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_PASSWORD;
                break;
            case 'submit':
                $ft = \AmeliaVendor\Dompdf\Cpdf::ACROFORM_FIELD_BUTTON;
                break;
        }
        $pdf->addFormField($ft, rand(), $x, $this->y($y) - $h, $x + $w, $this->y($y), $ff, $size, $color);
    }
