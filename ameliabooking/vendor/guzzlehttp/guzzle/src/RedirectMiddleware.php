...
use AmeliaVendor\GuzzleHttp\Exception\TooManyRedirectsException;
 ...
 * {@see \AmeliaVendor\GuzzleHttp\Middleware::redirect()}.
 *
 * @final
 */
class RedirectMiddleware
{
    ...
    public function checkRedirect(RequestInterface $request, array $options, ResponseInterface $response)
    {
        ...
        if (\AmeliaVendor\GuzzleHttp\Psr7\UriComparator::isCrossOrigin($request->getUri(), $nextRequest->getUri()) && defined('\CURLOPT_HTTPAUTH')) {
    ...
    public function modifyRequest(RequestInterface $request, array $options, ResponseInterface $response): RequestInterface
    {
        ...
        $modify['uri'] = $uri;
        \AmeliaVendor\GuzzleHttp\Psr7\Message::rewindBody($request);
        ...
        if (\AmeliaVendor\GuzzleHttp\Psr7\UriComparator::isCrossOrigin($request->getUri(), $modify['uri'])) {
            $modify['remove_headers'][] = 'Authorization';
            $modify['remove_headers'][] = 'Cookie';
        }
        return \AmeliaVendor\GuzzleHttp\Psr7\Utils::modifyRequest($request, $modify);
    }
    /**
    ...
    {
        $location = \AmeliaVendor\GuzzleHttp\Psr7\UriResolver::resolve($request->getUri(), new Psr7\Uri($response->getHeaderLine('Location')));
