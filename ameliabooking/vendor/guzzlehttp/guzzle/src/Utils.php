...
use AmeliaVendor\GuzzleHttp\Handler\CurlHandler;
use AmeliaVendor\GuzzleHttp\Handler\CurlMultiHandler;
use AmeliaVendor\GuzzleHttp\Handler\Proxy;
use AmeliaVendor\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \AmeliaVendor\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
     ...
     *
     * @return callable(\AmeliaVendor\Psr\Http\Message\RequestInterface, array): Promise\PromiseInterface Returns the best handler for the given system.
     *
    ...
    public static function chooseHandler(): callable
    {
        ...
        if (\ini_get('allow_url_fopen')) {
            ...
            throw new \RuntimeException('AmeliaVendor\GuzzleHttp requires cURL, the allow_url_fopen ini setting, or a custom HTTP handler.');
        }
        return $handler;
    }
    /**
    ...
    {
        return sprintf('AmeliaVendor\GuzzleHttp/%d', ClientInterface::MAJOR_VERSION);
    }
    /**
