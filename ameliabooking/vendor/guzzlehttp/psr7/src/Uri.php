...
namespace AmeliaVendor\GuzzleHttp\Psr7;

use AmeliaVendor\GuzzleHttp\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable
{
     ...
     * `AmeliaVendor\Psr\Http\Message\UriInterface::__toString`.
     *
     ...
     *
     * `AmeliaVendor\Psr\Http\Message\UriInterface::getPort` may return null or the standard port. This method can be used
