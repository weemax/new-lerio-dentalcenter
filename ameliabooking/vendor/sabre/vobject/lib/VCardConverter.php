...
class VCardConverter
{
     ...
     */
    public function convert(\AmeliaVendor\Sabre\VObject\Component\VCard $input, $targetVersion)
    {
     ...
     * @param int $targetVersion
     */
    protected function convertProperty(\AmeliaVendor\Sabre\VObject\Component\VCard $input, \AmeliaVendor\Sabre\VObject\Component\VCard $output, Property $property, $targetVersion)
    {
        ...
        if (Document::VCARD30 === $targetVersion) {
            if ($property instanceof \AmeliaVendor\Sabre\VObject\Property\Uri && in_array($property->name, ['PHOTO', 'LOGO', 'SOUND'])) {
                $newProperty = $this->convertUriToBinary($output, $newProperty);
            } elseif ($property instanceof \AmeliaVendor\Sabre\VObject\Property\VCard\DateAndOrTime) {
            ...
            if ($property instanceof \AmeliaVendor\Sabre\VObject\Property\Binary) {
                $newProperty = $this->convertBinaryToUri($output, $newProperty, $parameters);
            } elseif ($property instanceof \AmeliaVendor\Sabre\VObject\Property\VCard\DateAndOrTime && isset($parameters['X-APPLE-OMIT-YEAR'])) {
     ...
     * @return Property\Uri
     */
    protected function convertBinaryToUri(\AmeliaVendor\Sabre\VObject\Component\VCard $output, \AmeliaVendor\Sabre\VObject\Property\Binary $newProperty, array &$parameters)
    {
     ...
     */
    protected function convertUriToBinary(\AmeliaVendor\Sabre\VObject\Component\VCard $output, \AmeliaVendor\Sabre\VObject\Property\Uri $newProperty)
    {
        $value = $newProperty->getValue();
